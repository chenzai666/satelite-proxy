...
本分支最后核对：2026-09-23。选择性整合上游正式版至 1.0.40：设置页嵌入标签通过 flex 链按可见高度填充，移除空白滚动尾巴；英文界面和托盘文案按 `settings.locale` 补齐。后续补入上游 v1.0.40 笑脸土星应用图标及可选土星托盘样式；托盘默认仍为 Badge，Windows 主窗口图标修复保留。下行是此前功能的历史记录。
