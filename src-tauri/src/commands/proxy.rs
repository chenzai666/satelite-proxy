...
pub fn start_proxy(
    ...
    state
        .start_proxy(resource_dir.as_deref(), enable_system_proxy.unwrap_or(false))
...
#[tauri::command]
pub async fn smart_switch_now(
    state: State<'_, AppState>,
) -> Result<SmartSwitchNowResult, String> {
