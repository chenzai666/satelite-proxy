...
const en = {
  ...
  "dashboard.filterConfig": "Filter lines…",
  "dashboard.matchCount": "{n} / {total} lines",
  ...
  "settings.glassFrost": "Control style",
  "settings.glassFrostDesc": "Frosted is the default; solid fills spare compositing on low-end GPUs",
  "settings.glassFrostLite": "Solid",
  "settings.glassFrostFull": "Frosted",
  ...
  "settings.webviewMemory": "WebView2 memory",
  "settings.webviewHeap": "JS heap",
  "settings.coreBundledLabel": "Bundled",
  "settings.coreLatestLabel": "Latest",
  ...
  "settings.coreProxyRoute":
    "Proxy core is running · version checks and downloads use the current proxy.",
  "settings.coreDirectRoute":
    "Direct GitHub access · start the proxy first for more reliable checks and downloads.",
  ...
  "settings.appProxyRoute":
    "Proxy core is running · the update check goes through the current proxy.",
  "settings.appDirectRoute":
    "Direct GitHub access · start the proxy first for a more reliable check.",
...
const zh: Record<MessageKey, string> = {
  ...
  "dashboard.filterConfig": "输入字符串筛选行…",
  "dashboard.matchCount": "匹配 {n} / {total} 行",
  ...
  "settings.glassFrost": "控件风格",
  "settings.glassFrostDesc": "毛玻璃为默认；轻量实色可减轻低配设备的合成开销",
  "settings.glassFrostLite": "轻量",
  "settings.glassFrostFull": "毛玻璃",
  ...
  "settings.webviewMemory": "WebView2 内存",
  "settings.webviewHeap": "JS 堆",
  "settings.coreBundledLabel": "内置版本",
  "settings.coreLatestLabel": "最新版本",
  ...
  "settings.coreProxyRoute": "代理内核运行中 · 版本检测和下载均通过当前代理。",
  "settings.coreDirectRoute":
    "当前直连 GitHub · 先启动代理可提升版本检测和下载稳定性。",
  ...
  "settings.appProxyRoute": "代理内核运行中 · 版本检测通过当前代理。",
  "settings.appDirectRoute": "当前直连 GitHub · 先启动代理可提升检测稳定性。",
